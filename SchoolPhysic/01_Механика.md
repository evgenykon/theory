...
- `F = ma` — «равнодействующая сила равна массе, умноженной на ускорение»;
  И. В. Яковлев, «Физика» (MathUs.ru) — в пособии запись `ma = F`; форма
  `F = ma` более распространена в школьных учебниках (А. В. Перышкин).
- $\vec{F} = m\vec{a}$ — векторная форма; стандарт в вузовской литературе
  (И. Е. Иродов, «Механика»).
...
**Альтернативные записи / Alternative notations:**
- `F = -kx` — векторная форма со знаком минус, указывающим, что сила направлена
  против смещения; И. Е. Иродов, «Механика».
- $F_{\text{упр}} = kx$ — с индексом, обозначающим именно силу упругости;
  встречается в задачниках и справочниках (О. Ф. Кабардин, «Физика. Справочник»).
...
**Альтернативные записи / Alternative notations:**
- $\sigma = E\varepsilon$ — через механическое напряжение $\sigma = F/S$ и
  относительную деформацию $\varepsilon = x/l$; стандартная форма в курсе
  сопротивления материалов и вузовской физике (И. Е. Иродов).
- $k = \frac{ES}{l}$ — коэффициент жёсткости стержня, выраженный через модуль
  Юнга; Г. Я. Мякишев, «Физика. 10 класс».
...
**Альтернативные записи / Alternative notations:**
- $F = \gamma \frac{m_1 m_2}{r^2}$ — гравитационная постоянная обозначена
  греческой буквой `γ`; встречается в старой школьной литературе
  (А. В. Перышкин, издания до 2000-х) и в справочниках по физике.
- $\vec{F} = -G\frac{m_1 m_2}{r^2}\hat{r}$ — векторная форма с единичным радиус-вектором
  `r̂`; стандарт в курсе механики (И. Е. Иродов).
...
**Альтернативные записи / Alternative notations:**
- $F_{\text{т}} = mg$ — сила тяжести обозначается с индексом «т»; А. В. Перышкин,
  «Физика. 7 класс».
- $P = mg$ — в некоторых источниках вес тела и сила тяжести записываются одной
  буквой `P`, что может приводить к путанице; О. Ф. Кабардин, «Физика. Справочник».
...
**Альтернативные записи / Alternative notations:**
- $F_{\text{тр}} = \mu N$ — сила трения обозначается с индексом «тр»; наиболее
  распространённая форма в школьных учебниках (А. В. Перышкин).
- $f = \mu N$ — строчная буква `f`; используется в пособии И. В. Яковлева и в
  вузовских курсах, чтобы отличать силу трения от других сил.
...
**Альтернативные записи / Alternative notations:**
- $\frac{F_1}{F_2} = \frac{S_1}{S_2}$ — то же соотношение, записанное в обратном
  порядке; А. В. Перышкин, «Физика. 7 класс».
- $\frac{F_2}{F_1} = \frac{S_2}{S_1}$ — отношение на большом поршне к малому;
  форма пособия И. В. Яковлева.
...
**Альтернативные записи / Alternative notations:**
- $F_{\text{А}} = \rho_{\text{ж}} g V_{\text{пт}}$ — с индексами «ж» (жидкость) и
  «пт» (погружённая часть); А. В. Перышкин, «Физика. 7 класс».
- $F_{\text{А}} = \rho g V$ — форма пособия И. В. Яковлева; `ρ` — плотность жидкости,
...
**Альтернативные записи / Alternative notations:**
- $A = Fs\cos\alpha$ — общая форма, учитывающая угол $\alpha$ между силой и
  перемещением; А. В. Перышкин, «Физика. 7–9 класс» (также О. Ф. Кабардин).
- $A = \vec{F}\vec{s}$ — через скалярное произведение векторов силы и перемещения;
  И. Е. Иродов, «Механика».
...
**Альтернативные записи / Alternative notations:**
- $P = \frac{A}{t}$ — мощность обозначается буквой `P`; А. В. Перышкин,
  «Физика. 7 класс» (самый распространённый школьный вариант).
- $N = \frac{A}{t}$ — мощность обозначается буквой `N`; пособие И. В. Яковлева и
  часть вузовских курсов. Важно не путать `P` (мощность) с весом `P`.
...
**Альтернативные записи / Alternative notations:**
- $E_{\text{к}} = \frac{mv^2}{2}$ — кинетическая энергия обозначается `E` с индексом
  «к»; А. В. Перышкин, «Физика. 7–9 класс».
- $K = \frac{mv^2}{2}$ — буква `K`; пособие И. В. Яковлева и вузовские курсы.
...
**Альтернативные записи / Alternative notations:**
- $E_{\text{п}} = mgh$ — потенциальная энергия обозначается `E` с индексом «п»;
  А. В. Перышкин, «Физика. 7–9 класс».
- $W = mgh$ — буква `W`; пособие И. В. Яковлева и вузовские курсы (также
  обозначение $U$ — в некоторых зарубежных учебниках).
...
**Альтернативные записи / Alternative notations:**
- $\eta = \frac{A_{\text{полезн}}}{A_{\text{затр}}}$ — полная работа названа
  «затраченной»; А. В. Перышкин, «Физика. 7 класс».
- $\eta = \frac{A_{\text{полезн}}}{A_{\text{полн}}}$ — форма пособия И. В. Яковлева;
  «полная» работа — это та, что затрачена на самом деле.
